...
**Nunca uses raya larga.** Ni la raya (—) ni el guion medio (–) como signo de
puntuación dentro de una oración. Es la marca más reconocible de texto generado, y a estas
alturas mucha gente ya la lee así aunque no sepa nombrarla.

Casi siempre estaba tapando una decisión que no se tomó. Al quitarla, escoge:

- **Punto y aparte** cuando lo que sigue es una idea completa. Es la opción correcta más veces
  de las que parece.
- **Dos puntos** cuando lo que sigue explica o enumera lo anterior.
- **Coma** cuando es un inciso corto.
- **Paréntesis** cuando de verdad es un aparte que se puede saltar sin perder nada.
- **Punto y coma** entre dos ideas ligadas, con moderación.

El guion corto sí se usa donde toca: palabras compuestas y rangos de números o fechas
(2024-2025, páginas 10-14).

Cuidado al pegar texto de otro lado, que la raya viene escondida. Búscala antes de entregar.
...
Cero rayas largas, y el guion corto solo en compuestos y rangos:                ___
...
v0.2.0, sin calibrar. Estructura universal completa (vocabulario, anti-patrones, economía de
información, reglas de audiencia). Regla de puntuación sin raya larga agregada en v0.2.0.
Pendiente: minar patrones reales de Alex de una muestra de
